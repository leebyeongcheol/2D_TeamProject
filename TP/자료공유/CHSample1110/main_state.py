...
class Object:
    ...
    def draw(self):
        self.Lpipe.draw(600,114)
        self.cloud.draw(700,400)
        self.cloud.draw(400,550)

class Trap:
    global object_cloud_Y
    def __init__(self):
        self.cloud_trap = load_image("cloud.png")
        self.object_cloud_Y = 350
    def draw(self):
        self.cloud_trap.draw(200,self.object_cloud_Y)
...
def enter():
    global boy, grass, team, boyNum, mouseX, mouseY, monster,object,trap
    boy = Boy()
    grass = Grass()
    monster = monster()
    object = Object()
